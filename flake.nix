{
  ...
  outputs =
    ...
    let
      ...
      # TODO: make these into optional modules
      commonModule = { pkgs, ... }: {
        imports = [
    ...
    in
    {
      ...
      nixosConfigurations = {
        ...
        rakarake-thinkpad = (lib nixpkgs-unstable).nixosSystem {
          modules = [ ./hosts/rakarake-thinkpad/configuration.nix commonModule ];
          specialArgs = {
      ...
      homeConfigurations = {
        ...
        "rakarake@rakarake-thinkpad" = (lib nixpkgs-unstable).homeManagerConfiguration {
          modules = [ ./hosts/rakarake-thinkpad/home.nix commonHome ];
