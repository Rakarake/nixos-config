  ...
  users = {
    ...
    users.backup = {
      ...
      openssh.authorizedKeys.keys = [
        ''command="${pkgs.rrsync}/bin/rrsync --delete /data/backup/",restrict ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILgq+RAMpi4DsptmWOQXq+y/z1Ejt+63JL4vjY3Nmipi rakarake@creeper-spawner''
      ];
    };
  };
