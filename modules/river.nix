{ inputs, self, ... }: {
  flake.homeModules.river = { lib, config, pkgs, ... }:
   let
  ...
  in {
    ...
    xdg.configFile."kdeglobals".source = config.lib.file.mkOutOfStoreSymlink /home/${config.home.username}/Projects/nixos-config/home/${config.home.username}/kdeglobals;
    ...
    wayland.windowManager.river = {
      ...
      extraConfig = ''
        ...
        # Wallpaper
        swaybg -i ${./rakarake/wallpaper.png} &
